...
function HeroSection() {
  ...
  <div className="hero-content text-center text-white relative z-10 px-4 py-12 sm:px-8">
    <div className="max-w-5xl mx-auto">
      ...
      <p className="mb-10 text-base sm:text-lg md:text-xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light">
        ...
        Experience the rich culture, delicious cuisine, and warm hospitality of South Sumatra's capital.
      </p>
