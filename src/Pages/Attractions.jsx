  ...
  return (
    <section className="relative py-20 bg-gradient-to-b from-[#f9f4ef] via-[#f6f1ea] to-[#f9f4ef] text-center text-[#4b3832]">
      ...
      <div className="max-w-3xl mx-auto px-6">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-[#316D7C] via-[#8C7A66] to-[#C1A175] bg-clip-text text-transparent">
          ...
          {attractions.map((item, index) => (
            <div key={index} className="group">
              <div className="bg-gradient-to-br from-slate-50 via-teal-50 to-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-slate-200 group-hover:scale-105">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-semibold mb-3 text-slate-800 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                    {item.name}
                  </h3>
...
function FeaturedSection(){
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2">
    ...
    <div className="p-8 lg:p-12 flex flex-col justify-center">
      <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-[#4b3832] to-[#8c7a66] bg-clip-text text-transparent">
        Ampera Bridge
      </h2>
      <p className="text-lg leading-relaxed text-[#5e4b44] mb-8">
        The iconic Ampera Bridge is not just a means of transportation but a symbol of Palembang itself. Built
        in 1965, this magnificent bridge spans 1,177 meters across the Musi River and offers breathtaking views
        of the city skyline, especially during sunset.
      </p>
...
function ActionSection(){
    return(
        ...
        <p className="text-lg text-slate-700 mb-10 max-w-3xl mx-auto leading-relaxed">
          Need help planning your itinerary? Our local guides can help you make the most of your time in Palembang and
