...
import { Mail, Phone, MapPin, Clock, Send, ArrowRight, Sparkles, MessageCircle } from "lucide-react"
    ...
    <div className="space-y-16">
      <div>
        ...
        <p className="text-lg text-slate-700 mb-8 leading-relaxed">
          Our local tourism experts are here to help you plan the perfect visit to Palembang. Whether you need
          recommendations, bookings, or just have questions about our beautiful city, we're here to assist you.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="group">
          <div className="bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 p-6 text-center border border-[#F1EAE5] group-hover:scale-105">
            ...
            <p className="text-slate-700">info@palembang-tourism.com</p>
          </div>
        </div>
...
function FaqSection(){
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div className="collapse collapse-plus bg-white rounded-2xl shadow-xl border border-[#F1EAE5] transition-all duration-300">
      ...
      <div className="collapse-content">
        <p className="text-slate-700 leading-relaxed">
          The best time to visit Palembang is during the dry season from May to September when the weather is
          more pleasant for outdoor activities and sightseeing.
        </p>
      </div>
    </div>
    ...
    <div className="collapse collapse-plus bg-white rounded-2xl shadow-xl border border-[#F1EAE5] transition-all duration-300">
      ...
      <div className="collapse-content">
        <p className="text-slate-700 leading-relaxed">
          We recommend at least 3–4 days to explore the main attractions, experience the culture, and enjoy the
          local cuisine without rushing.
        </p>
      </div>
    </div>
    ...
    <div className="collapse collapse-plus bg-white rounded-2xl shadow-xl border border-[#F1EAE5] transition-all duration-300">
      ...
      <div className="collapse-content">
        <p className="text-slate-700 leading-relaxed">
          While Indonesian is the main language, many people in the tourism industry speak English. Our guides
          are fluent in English and can assist you throughout your visit.
        </p>
      </div>
    </div>
    ...
    <div className="collapse collapse-plus bg-white rounded-2xl shadow-xl border border-[#F1EAE5] transition-all duration-300">
      ...
      <div className="collapse-content">
        <p className="text-slate-700 leading-relaxed">
          Don't miss trying Pempek, the city's signature dish, along with other local specialties like Tekwan,
          Model, and Es Kacang Merah for a complete culinary experience.
        </p>
      </div>
    </div>
  </div>
